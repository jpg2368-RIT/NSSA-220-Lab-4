...
def main(args):
    ...
    plot.savefig("./graphs/mem.png")
    print(f"[!] Saved plot as \"mem.png\"\n")
    plot.clf()
    ...
    plot.savefig("./graphs/access.png")
    print("[!] Saved plot as \"access.png\"\n")
    plot.clf()
    ...
    plot.savefig("./graphs/util.png")
    print("[!] Saved plot as \"util.png\"\n")
    plot.clf()
